const dark = {
  ...
  colors: {
    ...
    background_secondary: '#050505', // secondary background color
    border_color: '#E9EDF5', // border color
    primary: '#a4448b', // primary button and link color
    secondary: '#793677', // secondary color - can be used for hover states
    black: '#252365', // black color
    gray: '#F8FAFC',
...
const light =  {breakpoints: ['376px', '576px', '768px', '992px', '1200px', '1600px'],
colors: {
