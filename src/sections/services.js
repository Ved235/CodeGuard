...
const SERVICES_DATA = [
  {
    ...
    text: "Makes your code hard to understand and protects code integrity.",
  },
  {
    icon: icon2,
    title: "Ease of Use",
    text: "Easy-to-use tool, just obfuscate with the click of a button.",
  },
  {
    icon: icon3,
    title: "Popular Languages",
    text: "Obfuscate the 2 most popular coding languages (JavaScript and Python)",
  },
  {
    icon: icon4,
    title: "Super Fast",
    text: "Obfuscate your code in no time due to our optimized algorithm",
  },
];
    ...
    <Box sx={styles.services} id="services">
      <Container>
        <BlockTitle
          ...
          title="Meet the exciting features of our tool"
